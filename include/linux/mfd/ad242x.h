...
#define AD242X_CAPABILITY_I2C		BIT(1)

#define AD242X_SWCTL			0x06
...
#define AD242X_SLOTFMT_DNSIZE(X)	(((((X) << 3) + 8) & 7) << 4)
#define AD242X_SLOTFMT_DNFMT		BIT(3)
#define AD242X_SLOTFMT_UPSIZE(X)	(((((X) << 3) + 8) & 7) << 4)
...
#define AD242X_CONTROL_MSTR		BIT(5)
...
#define AD242X_INTSRC_INODE(X)		((X) & 0xf)
...
#define AD242X_GPIODAT_OEN		0x4d
#define AD242X_GPIODAT_IEN		0x4e
...
#define AD242X_CLKCFG_PDIV		BIT(5)
...
#define AD242X_UPMASK0			0x60
#define AD242X_UPMASK1			0x61
#define AD242X_UPMASK2			0x62
#define AD242X_UPMASK3			0x63

#define AD242X_UPOFFSET			0x64
#define AD242X_UPOFFSET_VAL(X)		((X) & 0x1f)

#define AD242X_DNMASK0			0x65
#define AD242X_DNMASK1			0x66
#define AD242X_DNMASK2			0x67
#define AD242X_DNMASK3			0x68
...
struct ad242x_core {
	...
	struct i2c_client	*bus_i2c_client;
};

static inline struct ad242x_core *to_ad242x_core(struct device *dev) {
